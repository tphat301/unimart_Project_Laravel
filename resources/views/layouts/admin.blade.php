...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="{{url('/admin')}}">ISMART ADMIN</a></div>
            <div class="nav-right ">
    ...
    {{-- Tiny Editor --}}
    <script src="https://cdn.tiny.cloud/1/6exkcycuzl4n4cx1xx4333jpg4l4ahsk8nxrjw2d1kveux33/tinymce/4/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        var editor_config = {
            path_absolute : "https://thanhphat.unitopcv.com/project_unimart/",
