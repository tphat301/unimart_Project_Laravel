...
@section("title", "Đồng hồ thông minh")
@section("content")
<style type="text/css">
        ...
        <div class="main-content fl-right">
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    <h3 class="section-title fl-left">Đồng hồ thông minh</h3>
                    <div class="filter-wp fl-right">
                        <p class="desc">Hiển thị {{$get_smartwatch->total()}} trên {{$products->total()}} sản phẩm</p>
