        ...
        <div class="secion" id="breadcrumb-wp">
            <div class="secion-detail">
                <ul class="list-item clearfix">
                    ...
                    <li>
                        <a href="{{url('san-pham.html')}}" title="Danh sách sản phẩm">Danh sách sản phẩm</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="main-content fl-right" style="padding: 8px !important; box-shadow: 0 0 6px rgba(0, 0, 0, 0.3);">
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    <h3 class="section-title fl-left">Danh sách sản phẩm</h3>
                    <div class="filter-wp fl-right">
                        <p class="desc">Hiển thị {{$products->total()}} trên {{$products->total()}} sản phẩm</p>
                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        @if ($products->total() > 0)
                            ...
                            @endforeach
                        @else
                            <div class="report_text" style="display: block;overflow: hidden;padding: 15px 20px;font-size: 18px;color: #000;background: #fff;">
                                <h1>Rất tiếc, "ISMART" không tìm thấy sản phẩm nào! Để tìm được kết quả chính xác hơn, bạn vui lòng: <strong style="color: #cd1818">Kiểm tra lại bộ lọc đã chọn! Xin cảm ơn.</strong>
                            </div>
                        @endif 
                    </ul>
                </div>
